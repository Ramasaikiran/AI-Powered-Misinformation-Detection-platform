...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-cyber-black text-black dark:text-white font-sans grid-overlay">
      <Header 
      ...
      />
      <main className="flex-grow container mx-auto px-6 sm:px-8 py-24">
        {renderPage}
      </main>
      <Footer />
